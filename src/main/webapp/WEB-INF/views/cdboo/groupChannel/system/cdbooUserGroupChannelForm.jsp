...
<body>
	...
	<form:form id="inputForm" modelAttribute="cdbooUserGroup" action="${ctx}/channel/groupChannel/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<!-- 如果是修改，则用户锁定，不能编辑 -->
				<c:if test = "${not empty cdbooGroupChild.user.id && not empty cdbooUserChannel.channel.id}">
				...
				<!-- 如果是新增，则用户不锁定，允许编辑 -->
				<c:if test = "${empty cdbooGroupChild.user.id && empty cdbooUserChannel.channel.id}">
